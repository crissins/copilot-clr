...
@description('Bing Grounding connection name in AI Foundry project')
param bingGroundingConnectionName string = ''
      ...
      containers: [
        {
          ...
          env: [
            ...
            { name: 'BING_GROUNDING_CONNECTION_NAME', value: bingGroundingConnectionName }
